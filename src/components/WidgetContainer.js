      ...
      <div className="w-[400px] rounded-xl bg-dimgray-100 overflow-hidden shrink-0 flex flex-row items-start justify-start pt-[33px] px-[29px] pb-[35px] box-border gap-[33px] max-w-full z-[1] text-13xl font-work-sans mq800:flex-wrap mq450:gap-4">
        <div className="flex flex-col items-start justify-start gap-[4.5px] min-w-[243px] mq800:flex-1">
          ...
          <div className="flex flex-col items-start justify-start">
            <div className="h-[38px] relative inline-block whitespace-nowrap mq800:text-7xl mq450:text-lgi">
              <b>₦</b>
              <span className="font-medium">10,000,000.00</span>
            </div>
            <div className="relative text-xs font-medium font-poppins inline-block min-w-[86px] mt-[-0.5px]">
              Total Revenue
            </div>
          </div>
        </div>
        <div className="mt-[-44px] h-[110px] w-28 relative min-w-[112px] shrink-0 text-sm font-be-vietnam mq800:flex-1">
          <b className="absolute top-[23px] left-[0px] tracking-[-0.02em] leading-[24px] inline-block min-w-[66px] z-[1]">
            This Week
          </b>
